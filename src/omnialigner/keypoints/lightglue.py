...
class Attention(nn.Module):
    def __init__(self, allow_flash: bool=False) -> None:
        super().__init__()
...
class LightGlue(nn.Module):
    default_conf = {
        ...
        "input_dim": 384,  # input descriptor dimension (autoselected from weights)
        "descriptor_dim": 384,
        "add_scale_ori": False,
        "n_layers": 9,
        "num_heads": 4,
    ...
    def __init__(self, features=None, **conf) -> None:
        super().__init__()
